...
public class AuthMYSQLProperties {

    public static void main(String[] args) {
        duceapProperties(Constants.AUTH_DUCEAP_PROPRETIES_FILEPATH);
        System.out.println("权限服务 duceap.properties Mysql配置写入成功!");

        flywayProperties(Constants.AUTH_FLYWAY_PROPRETIES_FILEPATH);
...
//            p.load(new InputStreamReader(fs, "utf-8"));
            ...
            p.put("jdbc.url", "jdbc:mysql://192.168.120.142:3306/dcuc_auth?useUnicode=true&characterEncoding=gb2312",
            ...
            p = com.huanghy.onekey_switch_properties.dcuc_auth.AuthCommonProperties.duceapProperties(p);
    ...
    public static void flywayProperties(String filePath) {
        FlywayCommonProperties.flywayProperties(filePath,"v");
    }
}
