...
public class ListMYSQLProperties {

    public static void main(String[] args) {
        duceapProperties(Constants.LIST_DUCEAP_PROPRETIES_FILEPATH);
        System.out.println("名单服务 duceap.properties Mysql配置写入成功!");

        flywayProperties(Constants.LIST_FLYWAY_PROPRETIES_FILEPATH);
...
//            p.load(new InputStreamReader(fs, "utf-8"));
            ...
            p.put("jdbc.url", "jdbc:mysql://192.168.120.142:3306/dcuc_list?useUnicode=true&characterEncoding=gb2312",
            ...
            p = com.huanghy.onekey_switch_properties.dcuc_list.ListCommonProperties.duceapProperties(p);
