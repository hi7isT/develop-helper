...
public class OrgORACLEProperties {
...
//            p.load(new InputStreamReader(fs, "utf-8"));
            ...
            p.put("jdbc.username","yhglpt_org","数据库名称[开发环境中使用，并用于Flyway执行脚本]");
            ...
            p = com.huanghy.onekey_switch_properties.dcuc_org.OrgCommonProperties.duceapProperties(p);
