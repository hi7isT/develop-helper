...
public class OrgMYSQLProperties {

    public static void main(String[] args) {
        duceapProperties(Constants.ORG_DUCEAP_PROPRETIES_FILEPATH);
        System.out.println("机构服务 duceap.properties Mysql配置写入成功!");

        flywayProperties(Constants.ORG_FLYWAY_PROPRETIES_FILEPATH);
...
//            p.load(new InputStreamReader(fs, "utf-8"));
            ...
            p.put("jdbc.url", "jdbc:mysql://192.168.120.142:3306/dcuc_org?useUnicode=true&characterEncoding=gb2312",
            ...
            com.huanghy.onekey_switch_properties.dcuc_org.OrgCommonProperties.duceapProperties(p);
