...
public class TenantMYSQLProperties {

    public static void main(String[] args) {
        duceapProperties(Constants.TENANT_DUCEAP_PROPRETIES_FILEPATH);
        System.out.println("租户服务 duceap.properties Mysql配置写入成功!");

        flywayProperties(Constants.TENANT_FLYWAY_PROPRETIES_FILEPATH);
...
//            p.load(new InputStreamReader(fs, "utf-8"));
            ...
            p.put("jdbc.url", "jdbc:mysql://192.168.120.142:3306/dcuc_tenant?useUnicode=true&characterEncoding=gb2312",
            ...
            p = com.huanghy.onekey_switch_properties.dcuc_tenant.TenantCommonProperties.duceapProperties(p);
